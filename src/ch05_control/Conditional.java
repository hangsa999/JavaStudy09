...
public class Conditional {
    ...
    public static void main(String[] args) {
        ...
        // myMoney가 price보다 작으면 "돈이 부족합니다" 문구를 출력
        // 조건 안에는 boolean 타입의 결과가 들어간다.
        // 프로그램에서 괄호가 열렸으면 닫히는 부분이 있어야 한다.
        ...
        // boolean 타입의 true/false 성질을 마치 스위치의 on/off 처럼
