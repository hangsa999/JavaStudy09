...
public class ExceptionMain {
    public static void main(String[] args) throws Exception {
        ...
        // 대부분 예외 상황에 대해 에러가 났다고 표현
        // 깊게 들어갔을때의 에러는 코드에 실수가 있는 경우에 해상 (=코드를 고치기)
        ...
        try {
            ...
            aioobe.printStackTrace();   // 빨간 에러 메시지들 출력
        }
        ...
        try {
            System.out.println(intArray[10]);
        } catch (Exception e) {  // 모든 예외 클래스의 최상위 객체이므로 어떤 예외는 catch됨
            e.printStackTrace();
            ...
            // 스프링 프레임워크 (자바 서버 벡단을 맡음)
            // 에서의 예외처리 상황이라면 여기서 에러페이지로 전환하도록 함.
        }
...
//            System.out.println("1.밥밥밥 | 2. 잠잠잠 | 3. 종료");
//            System.out.print(">>> ");
//            int command = 0;
//            try {
...
//        }
        ...
        } catch (ArrayIndexOutOfBoundsException aioobe) { // 예측 가능한 예외 상황 처리
        ...
        // throw를 하지 않고, try - catch를 해준다.
        try {
            long time = ExMethod.dateToMillSec("2023.10.30");
        ...
        try {
            ...
            System.out.println("빈 문자열은 안됩니다.");
        } catch (ClassCastException c) {
            System.out.println("숫자도 안됩니다.");
        } catch (Exception e) {
            System.out.println("이건 모르겠는데...");
        }
