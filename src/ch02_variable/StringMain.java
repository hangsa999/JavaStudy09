...
public class StringMain {
    ...
    public static void main(String[] args) {
        ...
        // ,contains는 괄호 안 문자열을 포함하면 true, 포함하지 않으면 false 리턴
        ...
        System.out.println(fruits.substring(20));
        ...
        System.out.println(fruits.replace("Melon", "Mango"));
        ...
        // .concat(문자열)
        // 해당 문자열 뒤의 괄호 안에 문자열을 이어붙인 결과 리턴
        System.out.println(fruits.concat(", Cherry"));
        // 문자열 이어붙이기는 + 기호로도 구현 가능
